    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        salvar.setOnClickListener(v -> {
            ...
            if (nomeStr.isEmpty() || descricaoStr.isEmpty() || estoqueStr.isEmpty() || codigoStr.isEmpty()) {
                Toast
                        .makeText(this, "preencha todos os campos para alterar", Toast.LENGTH_SHORT)
                        .show();
            }
            else {
                ...
                repository.atualizarProduto(novoProduto,this.getFilesDir());

                Toast
                        .makeText(this, "produto alterado", Toast.LENGTH_SHORT)
                        .show();
